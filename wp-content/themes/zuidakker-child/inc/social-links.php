 ...
 * Manageable via wp-admin > Appearance > Customize > 📱 Social Media
 */
function zuidakker_get_social_links() {
    return array(
        'facebook' => array(
            'url' => get_theme_mod( 'zuidakker_social_facebook', 'https://facebook.com/zuidakker' ),
        ...
        'instagram' => array(
            'url' => get_theme_mod( 'zuidakker_social_instagram', 'https://instagram.com/zuidakker' ),
        ...
        'linkedin' => array(
            'url' => get_theme_mod( 'zuidakker_social_linkedin', 'https://linkedin.com/company/zuidakker' ),
        ...
        'youtube' => array(
            'url' => get_theme_mod( 'zuidakker_social_youtube', '' ),
...
/**
 * Output social links HTML directly in header
 */
function zuidakker_output_social_links() {
    $social_links = zuidakker_get_social_links();
...
add_action('wp_body_open', 'zuidakker_add_social_to_page', 1);
